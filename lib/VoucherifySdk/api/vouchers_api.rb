...
module VoucherifySdk
  class VouchersApi
    ...
    # @option opts [Boolean] :webhooks_enable Triggers a webhook sendout for new and updated vouchers if the voucher created and voucher updated webhooks are configured in Project settings.
    ...
    private def import_vouchers_using_csv_with_http_info(opts = {})
      ...
      form_params['webhooks_enable'] = opts[:'webhooks_enable'] if !opts[:'webhooks_enable'].nil?
