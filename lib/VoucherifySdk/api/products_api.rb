...
module VoucherifySdk
  class ProductsApi
    ...
    # @param product_id [String] A Voucherify [product](/api-reference/products/get-product) ID or product source ID.
    # @param [Hash] opts the optional parameters
    ...
    # @param product_id [String] A unique Voucherify [product](/api-reference/products/get-product) ID or product source ID.
    # @param sku_id [String] A Voucherify [SKU ID](/api-reference/products/get-sku) or SKU source ID.
    # @param [Hash] opts the optional parameters
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<ProductsUpdateInBulkRequestBody>] :products_update_in_bulk_request_body List the product fields to be updated in each product object.
