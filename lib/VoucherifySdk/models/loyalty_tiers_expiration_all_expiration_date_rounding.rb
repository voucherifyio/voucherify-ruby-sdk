...
module VoucherifySdk
  ...
  class LoyaltyTiersExpirationAllExpirationDateRounding
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["MONTH", "QUARTER", "HALF_YEAR", "YEAR", "CUSTOM"])
      return false unless type_validator.valid?(@type)
      strategy_validator = EnumAttributeValidator.new('String', ["START", "END"])
