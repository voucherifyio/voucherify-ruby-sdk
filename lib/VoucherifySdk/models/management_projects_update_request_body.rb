...
module VoucherifySdk
  ...
  class ManagementProjectsUpdateRequestBody
    ...
    def self.openapi_types
      {
        ...
        :'webhooks_callout_notifications' => :'ManagementProjectsUpdateRequestBodyWebhooksCalloutNotifications',
        :'api_usage_notifications' => :'ManagementProjectsUpdateRequestBodyApiUsageNotifications',
        :'default_code_config' => :'ManagementProjectsUpdateRequestBodyDefaultCodeConfig'
      }
    end
    ...
    def hash
      [name, description, timezone, currency, dial_code, webhook_version, client_trusted_domains, client_redeem_enabled, client_publish_enabled, client_list_vouchers_enabled, client_create_customer_enabled, client_loyalty_events_enabled, client_set_voucher_expiration_date_enabled, webhooks_callout_notifications, api_usage_notifications, default_code_config].hash
    end
