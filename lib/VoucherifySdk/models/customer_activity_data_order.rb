...
module VoucherifySdk
  class CustomerActivityDataOrder
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'items' => :'Array<CustomerActivityDataOrderItemsItem>',
        :'metadata' => :'Object',
        :'customer_id' => :'String',
        :'referrer_id' => :'String',
        :'object' => :'String',
        :'redemptions' => :'Object',
        :'customer' => :'CustomerActivityDataOrderCustomer',
        :'referrer' => :'CustomerActivityDataOrderReferrer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::CustomerActivityDataOrder` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::CustomerActivityDataOrder`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
