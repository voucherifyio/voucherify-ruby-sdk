...
module VoucherifySdk
  ...
  class ManagementProjectsUpdateResponseBodyLimits
    ...
    def self.openapi_types
      {
        :'api_calls' => :'Array<ManagementProjectsUpdateResponseBodyLimitsApiCallsItem>',
        :'bulk_api_calls' => :'Array<ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'bulk_api_calls')
        if (value = attributes[:'bulk_api_calls']).is_a?(Array)
          self.bulk_api_calls = value
        end
      end
    end
