...
module VoucherifySdk
  ...
  class LoyaltiesEarningRulesEnableResponseBody
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'created_at' => :'Time',
        :'loyalty' => :'LoyaltiesEarningRulesEnableResponseBodyLoyalty',
        :'event' => :'String',
        :'custom_event' => :'LoyaltiesEarningRulesEnableResponseBodyCustomEvent',
        :'segment' => :'LoyaltiesEarningRulesEnableResponseBodySegment',
        :'loyalty_tier' => :'LoyaltiesEarningRulesEnableResponseBodyLoyaltyTier',
        :'source' => :'LoyaltiesEarningRulesEnableResponseBodySource',
        :'object' => :'String',
    ...
    def hash
      [id, created_at, loyalty, event, custom_event, segment, loyalty_tier, source, object, automation_id, start_date, expiration_date, validity_timeframe, validity_day_of_week, validity_hours, metadata, updated_at, active].hash
    end
