    ...
    def self.openapi_types
      {
        ...
        :'webhooks_callout_notifications' => :'ManagementProjectWebhooksCalloutNotifications',
        :'api_usage_notifications' => :'ManagementProjectApiUsageNotifications',
        :'cluster_id' => :'String',
        :'case_sensitive_codes' => :'Boolean',
        :'api_version' => :'String',
        :'is_sandbox' => :'Boolean',
        :'webhook_token' => :'String',
        :'default_code_config' => :'ManagementProjectDefaultCodeConfig',
        :'limits' => :'ManagementProjectLimits'
      }
    end
