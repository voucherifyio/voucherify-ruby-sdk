...
module VoucherifySdk
  class LoyaltiesEarningRulesCreateRequestBodyItem
    ...
    def self.openapi_types
      {
        ...
        :'metadata' => :'Object',
        :'segment' => :'LoyaltiesEarningRulesCreateRequestBodyItemSegment',
        :'custom_event' => :'LoyaltiesEarningRulesCreateRequestBodyItemCustomEvent',
        :'loyalty_tier' => :'LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyTier'
      }
    end
    ...
    def hash
      [validation_rule_id, loyalty, event, source, active, start_date, expiration_date, pending_points, validity_timeframe, validity_day_of_week, validity_hours, metadata, segment, custom_event, loyalty_tier].hash
    end
