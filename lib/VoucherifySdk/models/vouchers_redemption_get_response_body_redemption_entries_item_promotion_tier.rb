...
module VoucherifySdk
  class VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTier
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'banner' => :'String',
        :'action' => :'VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTierAction',
        :'metadata' => :'Object',
        :'hierarchy' => :'Integer',
        :'promotion_id' => :'String',
        :'campaign' => :'VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTierCampaign',
        :'campaign_id' => :'String',
        :'active' => :'Boolean',
        :'start_date' => :'Time',
        :'expiration_date' => :'Time',
        :'validity_timeframe' => :'VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTierValidityTimeframe',
        :'validity_day_of_week' => :'Array<Integer>',
        :'validity_hours' => :'ValidityHours',
        :'summary' => :'VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTierSummary',
        :'object' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTier` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::VouchersRedemptionGetResponseBodyRedemptionEntriesItemPromotionTier`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
