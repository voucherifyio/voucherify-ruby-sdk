...
module VoucherifySdk
  class ParameterFiltersListCampaignsCampaignStatusConditions
    ...
    def valid?
      ...
      is_validator = EnumAttributeValidator.new('String', ["DONE", "IN_PROGRESS", "FAILED", "DRAFT", "MODIFYING"])
      return false unless is_validator.valid?(@is)
      is_not_validator = EnumAttributeValidator.new('String', ["DONE", "IN_PROGRESS", "FAILED", "DRAFT", "MODIFYING"])
