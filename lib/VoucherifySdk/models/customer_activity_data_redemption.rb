...
module VoucherifySdk
  class CustomerActivityDataRedemption
    ...
    def self.openapi_types
      {
        ...
        :'order' => :'CustomerActivityDataRedemptionOrder',
        :'previous_order' => :'OrderCalculated',
        :'reward' => :'CustomerActivityDataRedemptionReward',
        :'amount' => :'Integer',
        :'reason' => :'String',
        :'result' => :'String',
        :'status' => :'String',
        :'related_redemptions' => :'CustomerActivityDataRedemptionRelatedRedemptions',
        ...
        :'voucher' => :'CustomerActivityDataRedemptionVoucher',
        :'promotion_tier' => :'CustomerActivityDataRedemptionPromotionTier',
        :'date' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::CustomerActivityDataRedemption` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::CustomerActivityDataRedemption`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, object, created_at, tracking_id, metadata, channel_type, channel_id, failure_code, failure_message, order, previous_order, reward, amount, reason, result, status, related_redemptions, parent_redemption_id, redemption, customer, customer_id, related_object_type, related_object_id, related_object_parent_id, campaign_name, voucher, promotion_tier, date].hash
    end
