...
module VoucherifySdk
  ...
  class LoyaltiesMembersGetResponseBody
    ...
    def self.openapi_types
      {
        ...
        :'discount' => :'Object',
        :'gift' => :'Object',
        :'loyalty_card' => :'LoyaltiesMembersGetResponseBodyLoyaltyCard',
        :'start_date' => :'Time',
        ...
        :'holder_id' => :'String',
        :'object' => :'String',
        :'publish' => :'LoyaltiesMembersGetResponseBodyPublish',
        :'redemption' => :'LoyaltiesMembersGetResponseBodyRedemption'
      }
    end
    ...
    def hash
      [id, code, campaign, campaign_id, category, category_id, type, discount, gift, loyalty_card, start_date, expiration_date, validity_timeframe, validity_day_of_week, validity_hours, active, additional_info, metadata, assets, is_referral_code, created_at, updated_at, holder_id, object, publish, redemption].hash
    end
