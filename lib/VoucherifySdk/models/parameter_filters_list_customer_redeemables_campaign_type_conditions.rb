...
module VoucherifySdk
  class ParameterFiltersListCustomerRedeemablesCampaignTypeConditions
    ...
    def valid?
      ...
      is_validator = EnumAttributeValidator.new('String', ["LOYALTY_PROGRAM", "GIFT_VOUCHERS", "DISCOUNT_COUPONS", "REFERRAL_PROGRAM"])
      return false unless is_validator.valid?(@is)
      is_not_validator = EnumAttributeValidator.new('String', ["LOYALTY_PROGRAM", "GIFT_VOUCHERS", "DISCOUNT_COUPONS", "REFERRAL_PROGRAM"])
