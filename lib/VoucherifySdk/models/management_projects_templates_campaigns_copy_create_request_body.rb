...
module VoucherifySdk
  ...
  class ManagementProjectsTemplatesCampaignsCopyCreateRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'destination_project_id')
        self.destination_project_id = attributes[:'destination_project_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          destination_project_id == o.destination_project_id
    end
    ...
    def hash
      [name, description, destination_project_id].hash
    end
