...
module VoucherifySdk
  class ParameterFiltersListTemplates
    ...
    def self.openapi_types
      {
        :'junction' => :'Junction',
        :'id' => :'ParameterFiltersListTemplatesId',
        :'name' => :'ParameterFiltersListTemplatesName',
        :'campaign_type' => :'ParameterFiltersListTemplatesCampaignType'
      }
    end
    ...
    def hash
      [junction, id, name, campaign_type].hash
    end
