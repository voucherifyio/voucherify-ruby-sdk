  ...
  class CustomerSummaryOrders
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::CustomerSummaryOrders` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::CustomerSummaryOrders`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_order_date')
        self.last_order_date = attributes[:'last_order_date']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_order_amount == o.last_order_amount &&
    ...
    def hash
      [total_amount, total_count, average_amount, last_order_amount, last_order_date].hash
    end
