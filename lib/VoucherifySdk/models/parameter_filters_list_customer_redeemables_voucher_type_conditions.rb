...
module VoucherifySdk
  class ParameterFiltersListCustomerRedeemablesVoucherTypeConditions
    ...
    def valid?
      ...
      is_validator = EnumAttributeValidator.new('String', ["GIFT_VOUCHER", "DISCOUNT_VOUCHER", "LOYALTY_CARD"])
      return false unless is_validator.valid?(@is)
      is_not_validator = EnumAttributeValidator.new('String', ["GIFT_VOUCHER", "DISCOUNT_VOUCHER", "LOYALTY_CARD"])
      return false unless is_not_validator.valid?(@is_not)
      true
    end
    ...
    def hash
      [_in, not_in, is, is_not, has_value, is_unknown, starts_with, ends_with].hash
    end
