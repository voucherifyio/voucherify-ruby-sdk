  ...
  class RedemptionsGetResponseBodyPromotionTier
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'banner' => :'String',
        :'action' => :'RedemptionsGetResponseBodyPromotionTierAction',
        :'metadata' => :'Object',
        :'hierarchy' => :'Integer',
        :'promotion_id' => :'String',
        :'campaign' => :'RedemptionsGetResponseBodyPromotionTierCampaign',
        :'campaign_id' => :'String',
        :'active' => :'Boolean',
        :'start_date' => :'Time',
        :'expiration_date' => :'Time',
        :'validity_timeframe' => :'RedemptionsGetResponseBodyPromotionTierValidityTimeframe',
        :'validity_day_of_week' => :'Array<Integer>',
        :'validity_hours' => :'ValidityHours',
        :'summary' => :'RedemptionsGetResponseBodyPromotionTierSummary',
        :'object' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::RedemptionsGetResponseBodyPromotionTier` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::RedemptionsGetResponseBodyPromotionTier`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
