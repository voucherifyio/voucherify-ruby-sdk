...
module VoucherifySdk
  class ParameterFiltersListBinResourceTypeConditions
    ...
    def valid?
      ...
      is_validator = EnumAttributeValidator.new('String', ["campaign", "product", "sku", "voucher"])
      return false unless is_validator.valid?(@is)
      is_not_validator = EnumAttributeValidator.new('String', ["campaign", "product", "sku", "voucher"])
