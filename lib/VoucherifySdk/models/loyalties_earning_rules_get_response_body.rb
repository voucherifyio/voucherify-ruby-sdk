    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'created_at' => :'Time',
        :'loyalty' => :'LoyaltiesEarningRulesGetResponseBodyLoyalty',
        :'event' => :'String',
        :'custom_event' => :'LoyaltiesEarningRulesGetResponseBodyCustomEvent',
        :'segment' => :'LoyaltiesEarningRulesGetResponseBodySegment',
        :'loyalty_tier' => :'LoyaltiesEarningRulesGetResponseBodyLoyaltyTier',
        :'pending_points' => :'LoyaltiesEarningRulesGetResponseBodyPendingPoints',
