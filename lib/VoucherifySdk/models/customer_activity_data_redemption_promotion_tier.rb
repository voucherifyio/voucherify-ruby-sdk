...
module VoucherifySdk
  class CustomerActivityDataRedemptionPromotionTier
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'banner' => :'String',
        :'action' => :'CustomerActivityDataRedemptionPromotionTierAction',
        :'metadata' => :'Object',
        :'hierarchy' => :'Integer',
        :'promotion_id' => :'String',
        :'campaign' => :'CustomerActivityDataRedemptionPromotionTierCampaign',
        :'campaign_id' => :'String',
        :'active' => :'Boolean',
        :'start_date' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::CustomerActivityDataRedemptionPromotionTier` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::CustomerActivityDataRedemptionPromotionTier`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
