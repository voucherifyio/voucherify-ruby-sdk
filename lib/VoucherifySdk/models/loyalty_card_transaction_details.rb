...
module VoucherifySdk
  ...
  class LoyaltyCardTransactionDetails
    ...
    def self.openapi_types
      {
        :'balance' => :'LoyaltyCardTransactionDetailsBalance',
        :'order' => :'LoyaltyCardTransactionDetailsOrder',
        :'event' => :'LoyaltyCardTransactionDetailsEvent',
        :'earning_rule' => :'LoyaltyCardTransactionDetailsEarningRule',
        :'segment' => :'LoyaltyCardTransactionDetailsSegment',
        :'loyalty_tier' => :'LoyaltyCardTransactionDetailsLoyaltyTier',
        :'redemption' => :'LoyaltyCardTransactionDetailsRedemption',
