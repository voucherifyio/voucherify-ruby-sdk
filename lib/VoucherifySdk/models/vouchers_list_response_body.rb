...
module VoucherifySdk
  ...
  class VouchersListResponseBody
    ...
    def self.openapi_types
      {
        :'object' => :'String',
        :'data_ref' => :'String',
        :'vouchers' => :'Array<VoucherWithCategories>',
        :'total' => :'Integer'
      }
    end
    ...
    def valid?
      ...
      data_ref_validator = EnumAttributeValidator.new('String', ["vouchers"])
    ...
    def hash
      [object, data_ref, vouchers, total].hash
    end
