...
module VoucherifySdk
  ...
  class PublicationsCreateVouchersResponseBody
    ...
    def hash
      [id, object, created_at, customer_id, tracking_id, metadata, channel, source_id, result, customer, vouchers_id, vouchers].hash
    end
