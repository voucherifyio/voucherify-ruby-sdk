...
module VoucherifySdk
  ...
  class ParameterFiltersListTemplatesCampaignTypeConditions
    ...
    def valid?
      ...
      is_validator = EnumAttributeValidator.new('String', ["DISCOUNT_COUPONS", "GIFT_VOUCHERS"])
      return false unless is_validator.valid?(@is)
      is_not_validator = EnumAttributeValidator.new('String', ["DISCOUNT_COUPONS", "GIFT_VOUCHERS"])
