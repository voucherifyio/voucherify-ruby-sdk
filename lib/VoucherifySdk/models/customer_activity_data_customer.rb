...
module VoucherifySdk
  class CustomerActivityDataCustomer
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'source_id' => :'String',
        :'summary' => :'CustomerActivityDataCustomerSummary',
        :'loyalty' => :'CustomerActivityDataCustomerLoyalty',
        :'referrals' => :'CustomerActivityDataCustomerReferrals',
        :'system_metadata' => :'Object',
        :'created_at' => :'Time',
        :'updated_at' => :'Time',
        :'assets' => :'CustomerActivityDataCustomerAssets',
        :'object' => :'String',
        :'name' => :'String',
        :'description' => :'String',
        :'email' => :'String',
        ...
        :'birthday' => :'Date',
        :'birthdate' => :'Date',
        :'address' => :'CustomerActivityDataCustomerAddress',
        :'metadata' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::CustomerActivityDataCustomer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::CustomerActivityDataCustomer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
