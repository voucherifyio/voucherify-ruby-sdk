...
module VoucherifySdk
  class CampaignsUpdateLoyaltyCampaign
    ...
    def hash
      [start_date, expiration_date, validity_timeframe, validity_day_of_week, description, category, metadata, unset_metadata_fields, category_id, activity_duration_after_publishing, join_once, auto_join, type, loyalty_tiers_expiration, options].hash
    end
