...
module VoucherifySdk
  ...
  class RedeemableVoucher
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'String',
        :'discount' => :'Discount',
        :'gift' => :'RedeemableVoucherGift',
        :'loyalty_card' => :'RedeemableVoucherLoyaltyCard',
        :'start_date' => :'Time',
        ...
        :'holder_id' => :'String',
        :'object' => :'String',
        :'publish' => :'RedeemableVoucherPublish',
        :'redemption' => :'RedeemableVoucherRedemption'
      }
    end
    ...
    def hash
      [id, code, campaign, campaign_id, category, category_id, categories, type, discount, gift, loyalty_card, start_date, expiration_date, validity_timeframe, validity_day_of_week, validity_hours, active, additional_info, metadata, assets, is_referral_code, created_at, updated_at, referrer_id, holder_id, object, publish, redemption].hash
    end
