  ...
  class EarningRuleBaseLoyalty
    ...
    def self.openapi_types
      {
        ...
        :'order' => :'EarningRuleBaseLoyaltyOrder',
        :'order_items' => :'EarningRuleBaseLoyaltyOrderItems',
        :'customer' => :'EarningRuleBaseLoyaltyCustomer',
        :'custom_event' => :'EarningRuleBaseLoyaltyCustomEvent',
        :'points' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::EarningRuleBaseLoyalty` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::EarningRuleBaseLoyalty`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["PROPORTIONAL", "FIXED"])
    ...
    def calculation_type=(calculation_type)
      validator = EnumAttributeValidator.new('String', ["ORDER_AMOUNT", "ORDER_TOTAL_AMOUNT", "ORDER_METADATA", "ORDER_ITEMS_QUANTITY", "ORDER_ITEMS_AMOUNT", "ORDER_ITEMS_SUBTOTAL_AMOUNT", "CUSTOMER_METADATA", "CUSTOM_EVENT_METADATA"])
