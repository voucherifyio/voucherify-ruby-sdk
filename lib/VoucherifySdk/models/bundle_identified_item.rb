...
module VoucherifySdk
  ...
  class BundleIdentifiedItem
    ...
    def list_invalid_properties
      ...
      if @item_index < 0
        invalid_properties.push('invalid value for "item_index", must be greater than or equal to 0.')
      end
    ...
    def hash
      [id, object, item_index, item_quantity].hash
    end
