...
module VoucherifySdk
  class EarningRuleBase
    ...
    def hash
      [id, created_at, loyalty, event, custom_event, segment, source, object, automation_id, start_date, expiration_date, validity_timeframe, validity_day_of_week, metadata].hash
    end
