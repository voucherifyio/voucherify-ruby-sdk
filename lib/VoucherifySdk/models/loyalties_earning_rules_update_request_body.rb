...
module VoucherifySdk
  class LoyaltiesEarningRulesUpdateRequestBody
    ...
    def hash
      [validation_rule_id, loyalty, source, active, start_date, expiration_date, pending_points, expiration_rules, validity_timeframe, validity_day_of_week, validity_hours, metadata].hash
    end
