...
module VoucherifySdk
  ...
  class ValidationRulesUpdateResponseBody
    ...
    def self.openapi_types
      {
        ...
        :'rules' => :'Object',
        :'bundle_rules' => :'Object',
        :'error' => :'ValidationRulesUpdateResponseBodyError',
        :'applicable_to' => :'ValidationRulesUpdateResponseBodyApplicableTo',
        :'type' => :'String',
        :'context_type' => :'String',
        :'id' => :'String',
        :'created_at' => :'Time',
    ...
    def hash
      [name, rules, bundle_rules, error, applicable_to, type, context_type, id, created_at, updated_at, assignments_count, object].hash
    end
