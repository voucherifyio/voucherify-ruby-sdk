  ...
  class EventCustomerRewarded
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::EventCustomerRewarded` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::EventCustomerRewarded`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'referral_tier')
        self.referral_tier = attributes[:'referral_tier']
      end
      ...
      if attributes.key?(:'customer_event')
        self.customer_event = attributes[:'customer_event']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reward == o.reward &&
          referral_tier == o.referral_tier &&
          balance == o.balance &&
          custom_event == o.custom_event &&
          customer_event == o.customer_event
    end
    ...
    def hash
      [customer, holder, voucher, campaign, redemption, reward, referral_tier, balance, custom_event, customer_event].hash
    end
