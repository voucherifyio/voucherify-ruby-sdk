  ...
  class LoyaltiesMembersPointsExpirationListResponseBody
    ...
    def self.openapi_types
      {
        :'object' => :'String',
        :'data_ref' => :'String',
        :'data' => :'Array<LoyaltiesMembersPointsExpirationListResponseBodyDataItem>',
        :'total' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VoucherifySdk::LoyaltiesMembersPointsExpirationListResponseBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VoucherifySdk::LoyaltiesMembersPointsExpirationListResponseBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/list/)
      if !@object.nil? && @object !~ pattern
        invalid_properties.push("invalid value for \"object\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/data/)
      if !@data_ref.nil? && @data_ref !~ pattern
        invalid_properties.push("invalid value for \"data_ref\", must conform to the pattern #{pattern}.")
      end
