...
module VoucherifySdk
  ...
  class CustomersPermanentDeletionCreateResponseBodyDataJson
    ...
    def ==(o)
      ...
      self.class == o.class &&
          events == o.events &&
          customer_events == o.customer_events &&
    ...
    def hash
      [events, customer_events, daily_events, segments, orders, order_events, customer].hash
    end
