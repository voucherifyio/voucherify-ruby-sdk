...
module VoucherifySdk
  ...
  class LoyaltyPendingPointsDetailsEvent
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["customer.order.paid"])
      return false unless type_validator.valid?(@type)
      category_validator = EnumAttributeValidator.new('String', ["ACTION", "EFFECT"])
    ...
    def hash
      [id, type, group_id, entity_id, created_at, category, event_source].hash
    end
