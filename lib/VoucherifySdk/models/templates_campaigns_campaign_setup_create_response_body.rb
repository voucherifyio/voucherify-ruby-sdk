...
module VoucherifySdk
  ...
  class TemplatesCampaignsCampaignSetupCreateResponseBody
    ...
    def self.openapi_types
      {
        :'created_resources' => :'Array<TemplatesCampaignsCampaignSetupCreateResponseBodyCreatedResourcesItem>',
        :'campaign' => :'Campaign',
        :'object' => :'String'
      }
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["campaign_setup"])
    ...
    def hash
      [created_resources, campaign, object].hash
    end
