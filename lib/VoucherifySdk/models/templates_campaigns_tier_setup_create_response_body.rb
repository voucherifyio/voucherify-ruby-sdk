...
module VoucherifySdk
  ...
  class TemplatesCampaignsTierSetupCreateResponseBody
    ...
    def self.openapi_types
      {
        :'created_resources' => :'Array<TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'object')
        ...
        self.object = 'promotion_tier_setup'
      end
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["promotion_tier_setup"])
    ...
    def hash
      [created_resources, promotion_tier, object].hash
    end
