...
| **created_at** | **Time** | Timestamp representing the date and time when the earning rule was created. The value is shown in the ISO 8601 format. |  |
...
| **object** | **String** | The type of the object represented by JSON. Default is earning_rule. | [default to &#39;earning_rule&#39;] |
