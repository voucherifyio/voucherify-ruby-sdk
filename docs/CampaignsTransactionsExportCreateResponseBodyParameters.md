# VoucherifySdk::CampaignsTransactionsExportCreateResponseBodyParameters
...
| **fields** | **Array&lt;String&gt;** | Data fields that will be exported for the transactions that are associated with balance movements on cards in a campaign. | [optional] |
